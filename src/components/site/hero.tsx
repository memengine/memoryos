      ...
      <div className="container-page">
        ...
        >
          <Button
            asChild
            size="lg"
            className="bg-mem text-[#0A0B0D] hover:bg-mem/90 font-semibold h-12 px-6 rounded-xl text-[15px] gap-2 shadow-[0_0_0_1px_oklch(0.92_0.17_145_/_40%),0_10px_40px_-12px_oklch(0.92_0.17_145_/_60%)]"
          >
            <a href="#cta">
              Try MemoryOS
